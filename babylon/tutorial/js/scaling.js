var createScene = function () {
	...
	var printsca = function() {

		var scene = engine.scenes[0];

		var sstr_r, sstr_g, sstr_b;
		sstr_x = scene.mybox.scaling.x.toFixed(2);
		sstr_y = scene.mybox.scaling.y.toFixed(2);
		sstr_z = scene.mybox.scaling.z.toFixed(2);

		canvas.mydiv1.textContent = "mybox.scaling = " +
			"new BABYLON.Vector3(" +
			sstr_x + ", " +
			sstr_y + ", " +
			sstr_z +
		...
		canvas.mydiv1a.textContent = "mybox.scaling.x = " + sstr_x;
		canvas.mydiv1b.textContent = "mybox.scaling.y = " + sstr_y;
		canvas.mydiv1c.textContent = "mybox.scaling.z = " + sstr_z;
	};
